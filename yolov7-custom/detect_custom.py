...
def detect(save_img=True, source=""):
    # 不查看图片
    view_img = False
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # Apply NMS 对类不进行限制
        # pred = non_max_suppression(pred, conf_thres, iou_thres, classes=opt.classes, agnostic=agnostic_nms)
...
if __name__ == '__main__':
    ...
    classes:设置只保留某一部分类别，例如0或者0 2 3
    ...
    device = select_device(device_digs)
